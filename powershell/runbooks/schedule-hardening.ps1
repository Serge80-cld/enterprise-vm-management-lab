$taskName = "VM-Hardening"
$scriptPath = "$PSScriptRoot\..\hardening\hardening-windows.ps1"
...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  <Triggers>
    <CalendarTrigger>
      <StartBoundary>$(Get-Date -Format "yyyy-MM-ddT04:00:00")</StartBoundary>
...
$xmlPath = "$env:TEMP\hardening.xml"
